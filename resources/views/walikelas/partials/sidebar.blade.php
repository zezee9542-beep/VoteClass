...
<aside class="sidebar" id="sidebar">
    ...
    <div class="px-6 pt-6 pb-5 logo-container flex items-center">
        <a href="/walikelas/dashboard" class="flex items-center gap-3 whitespace-nowrap">
    ...
    <nav class="flex-1 overflow-y-auto sidebar-scroll px-3 py-2">
        ...
        <!-- Beranda -->
        <a href="/walikelas/dashboard" class="sidebar-nav-item mb-1 {{ request()->is('walikelas/dashboard') ? 'active' : '' }}">
        ...
        <div class="sidebar-section-label sidebar-text">Kelola Data</div>

        <!-- Pengguna -->
        <a href="/walikelas/users" class="sidebar-nav-item mb-1 {{ request()->is('walikelas/users') ? 'active' : '' }}">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <span class="sidebar-text">Siswa {{ Auth::user()->class?->class_name ?? 'Kelas' }}</span>
        </a>

        <!-- Kandidat -->
        <a href="/walikelas/candidates" class="sidebar-nav-item mb-1 {{ request()->is('walikelas/candidates*') ? 'active' : '' }}">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <!-- Data Suara -->
        <a href="/walikelas/votes" class="sidebar-nav-item mb-1 {{ request()->is('walikelas/votes') ? 'active' : '' }}">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <polyline points="9 11 12 14 22 4"/>
                <path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/>
            </svg>
            <span class="sidebar-text">Data Suara</span>
        </a>

        <!-- Hasil Voting -->
        <a href="/walikelas/voting-results" class="sidebar-nav-item mb-1 {{ request()->is('walikelas/voting-results') ? 'active' : '' }}">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
